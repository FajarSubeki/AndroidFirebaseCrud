...
import com.example.crudfirebase.Adapter.TrackAdapter;
...
public class ArtistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseTracks = FirebaseDatabase.getInstance().getReference("tracks").child(intent.getStringExtra(CrudActivity.ARTIST_ID));
        ...
        textViewArtist.setText(intent.getStringExtra(CrudActivity.ARTIST_NAME));
    ...
    protected void onStart() {
        ...
        databaseTracks.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                TrackAdapter trackListAdapter = new TrackAdapter(ArtistActivity.this, tracks);
